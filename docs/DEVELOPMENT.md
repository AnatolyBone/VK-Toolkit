...
6. Перезагрузите VK и убедитесь, что счётчик сообщений восстановился и сбор можно продолжить.
7. Проверьте в мастере экспорт всей истории, последних N сообщений и диапазона дат.
8. Распакуйте ZIP, откройте `viewer.html`, сверьте SHA-256 из `archive.json` и каталог `media`.
9. Включите шифрование, создайте `.vkt`, проверьте правильный и неправильный пароль в локальном расшифровщике.
10. Проверьте, что после отключения модуля его UI и обработчики исчезли.
