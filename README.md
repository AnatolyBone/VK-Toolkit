...
Расширение для `vk.ru` и `vk.com` с независимыми модулями и настройками в `chrome.storage.sync`. Версия: **0.2.4**.
...
- **Диалоги** — network-first сбор сообщений с DOM fallback, дедупликация по CMID, загрузка истории прокруткой и проверяемый ZIP-архив с JSON/HTML/TXT/analysis/media и SHA-256.
