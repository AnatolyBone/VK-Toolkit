...
Расширение для `vk.ru` и `vk.com` с независимыми модулями и настройками в `chrome.storage.sync`. Версия: **0.3.1**.
...
- **Диалоги** — управляемый network-first сбор с DOM fallback, дедупликация по CMID, проверяемый ZIP, локальный viewer, аналитика, инкрементальный режим и приватный экспорт.
