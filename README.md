...
Расширение для `vk.ru` и `vk.com` с независимыми модулями и настройками в `chrome.storage.sync`. Версия: **0.10.0**.
...
- **Диалоги** — управляемый network-first сбор с DOM fallback, дедупликация по CMID, проверяемый ZIP, локальный viewer, аналитика, структурированные вложения, инкрементальный режим, обезличивание и AES-256-GCM шифрование.
